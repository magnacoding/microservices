...
import com.imaging.content.received.module.service.ImagingDocument;
...
public class DocumentController {
    ...
    @Autowired
    public DocumentController(ImagingDocument imagingDocument) {
        this.imagingDocument = imagingDocument;
    }
